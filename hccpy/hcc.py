...
# Example usage:
# Replace dx_lst, age, sex, elig, orec, and medicaid with your actual data
result = hcc_engine_instance.profile(
    dx_lst=["C7911", "C8440", "C220", "C8110", "C9211", "C4310"], age=70, sex="M", elig="CNA", orec="0", medicaid=False)

description = hcc_engine_instance.describe_hcc(
    cc=hcc_engine_instance.profile.hcc_lst[0])
# Access the result
print(result)
