...
# import utils
# import _V22I0ED2 as V22I0ED2  # age sex edits (v22, v23, v24)
# import _V28I0ED1 as V28I0ED1  # age sex edits (v28)
# import _V221801M as V221801M  # interactions (v22)
# import _V2318P1M as V2318P1M  # interactions (v23)
# import _V2419P1M as V2419P1M  # interactions (v24)
# import _V2823T2M as V2823T2M  # interactions (v28)
# import _E2118P1M as E2118P1M  # interactions (ESRD)
# import _AGESEXV2 as AGESEXV2  # disabled/origds (v22, v23, v24, v28)
# import _V221801P as V2218O1P  # risk coefn (v22, v23, v24, v28)
# import _E2118P1P as E2118P1P  # risk coefn for ESRD

import numpy as np
import re
from collections import Counter
from src import utils
from src import _V22I0ED2 as V22I0ED2  # age sex edits (v22, v23, v24)
from src import _V28I0ED1 as V28I0ED1  # age sex edits (v28)
from src import _V221801M as V221801M  # interactions (v22)
from src import _V2318P1M as V2318P1M  # interactions (v23)
from src import _V2419P1M as V2419P1M  # interactions (v24)
from src import _V2823T2M as V2823T2M  # interactions (v28)
from src import _E2118P1M as E2118P1M  # interactions (ESRD)
from src import _AGESEXV2 as AGESEXV2  # disabled/origds (v22, v23, v24, v28)
from src import _V221801P as V2218O1P  # risk coefn (v22, v23, v24, v28)
from src import _E2118P1P as E2118P1P  # risk coefn for ESRD
...
class HCCEngine:
    ...
    def __init__(self,
        ...
        assert fnmaps[version]["dx2cc"].get(
            dx2cc_year), "Invalid combination of version and year parameters"
        ...
        if "label_short" in fnmaps[version]:
            self.label_short = read_label_short(
    ...
    def describe_hcc(self, cc):
        ...
        out = {
            "description": cc_desc,
            "child HCCs": cc_children,
            "parent HCCs": cc_parents
        }
        return out
...
# # Create an instance of HCCEngine
...
#     dx_lst=["C7911", "C8440", "C220", "C8110", "C9211", "C4310"], age=70, sex="M", elig="CNA", orec="0", medicaid=False)

# print(result)


# # Iterate over each HCC code in 'hcc_map' and 'hcc_lst' and get descriptions
...
#         print(f"ICD10 Code: {icd10_code}, Chronic Condition Code: {hcc_code}")
#         print("Description:", hcc_description)
#         print("-")

# # Get description for only the first element in 'hcc_lst'
# first_hcc_code = result['hcc_lst'][0]
# first_hcc_description = hcc_engine_instance.describe_hcc(first_hcc_code)
# print(f"Hierarchial Chronic Condition Code: {first_hcc_code}")
# print("Description:", first_hcc_description)
